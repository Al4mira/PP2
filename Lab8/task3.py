...
def main():
    ...
    while True:
            ...
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:  
                    ...
                    if mode == 'circle':  # center and radius
                        ...
                        lines.append({'type': 'filled_rectangle', 'start': event.pos, 'end': event.pos, 'color': drawing_color})
                    else:
        ...
        for line in lines:
            ...
            elif line['type'] == 'filled_rectangle':
                start = line['start']
                end = line['end']
                pygame.draw.rect(temp_surface, line['color'], (start[0], start[1], end[0] - start[0], end[1] - start[1]))
